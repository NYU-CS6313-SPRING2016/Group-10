...
#connect to database
try:
    connection = psycopg2.connect("dbname=nyc_twitter_db user=nyctwitter host=aws_server password=our_password")
except:
    print "Connection error"

#Twitter APP Credentials
consumer_key = 'qAreiJugVs3vgadeCRGpTMSB0'
consumer_secret = 'FVzXjDrHuqU5EuWdTti1U2oh9QZytr3j0mKet90njSt1UiV7wd'
access_token = '108979136-GGZBwlRfniiBPMI8jEq4am4CINPmTOi2YQuqc8u5'
access_secret = '4krOt7lYYS9leMDHNREJ15Mff3i9Vo4ouOba5Dm28ponl'
